...
#include "AoPrepareDepthBuffers1CS.h"
#include "AoPrepareDepthBuffers2CS.h"
#include "LinearizeDepthCS.h"
#include "DebugSSAOCS.h"
#include "AoRender1CS.h"
#include "AoRender2CS.h"
#include "AoBlurUpsampleBlendOutCS.h"
#include "AoBlurUpsamplePreMinBlendOutCS.h"
#include "AoBlurUpsampleCS.h"
#include "AoBlurUpsamplePreMinCS.h"
...
namespace SSAO
{
	...
	QualityLevel g_QualityLevel = kSsaoQualityHigh;
...
void SSAO::LinearizeDepth(GraphicsContext& gfxContext, const Math::Camera& camera)
{
	const float* ProjMat = reinterpret_cast<const float*>(&camera.GetProjMatrix());
