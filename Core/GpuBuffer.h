...
public:
    ...
    void Create( const std::wstring& name, uint32_t NumElements, uint32_t ElementSize,
        const void* initialData = nullptr, D3D12_HEAP_FLAGS heapFlags = D3D12_HEAP_FLAG_NONE);
	...
	void Update(uint32_t startingAddress, uint32_t NumElements, const void* data);
...
// write as ByteAddressBuffer, Read as StructuredBuffer
class MixedBuffer : public GpuBuffer
{
public:
	virtual void CreateDerivedViews(void) override;
};
