...
namespace FXAA
{
    ...
    BoolVar Enable("Post Effects/AA/FXAA/Enable", true);
    BoolVar DebugDraw("Post Effects/AA/FXAA/Debug", false);

    // With a properly encoded luma buffer, [0.25 = "low", 0.2 = "medium", 0.15 = "high", 0.1 = "ultra"]
    NumVar ContrastThreshold("Post Effects/AA/FXAA/Contrast Threshold", 0.175f, 0.05f, 0.5f, 0.025f);

    // Controls how much to blur isolated pixels that have little-to-no edge length.
    NumVar SubpixelRemoval("Post Effects/AA/FXAA/Subpixel Removal", 0.50f, 0.0f, 1.0f, 0.25f);
    ...
    BoolVar ForceOffPreComputedLuma("Post Effects/AA/FXAA/Always Recompute Log-Luma", false);
}
