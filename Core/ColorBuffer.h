...
public:
	...
	// Create 1D texture
	void CreateTex1D(const std::wstring& Name, uint32_t Width,
...
protected:
	...
	void CreateDerivedViews1D(ID3D12Device* Device, DXGI_FORMAT Format, uint32_t ArraySize, uint32_t NumMips = 1);
