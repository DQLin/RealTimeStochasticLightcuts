...
#include "ParticleLargeBinCullingCS.h"
#include "ParticleBinCullingCS.h"

#include "ParticleTileRenderCS.h"
#include "ParticleTileRenderFastCS.h"
#include "ParticleTileRenderSlowDynamicCS.h"
#include "ParticleTileRenderFastDynamicCS.h"
#include "ParticleTileRenderSlowLowResCS.h"
#include "ParticleTileRenderFastLowResCS.h"

#include "ParticleTileRender2CS.h"
#include "ParticleTileRenderFast2CS.h"
#include "ParticleTileRenderSlowDynamic2CS.h"
#include "ParticleTileRenderFastDynamic2CS.h"
#include "ParticleTileRenderSlowLowRes2CS.h"
#include "ParticleTileRenderFastLowRes2CS.h"

#include "ParticleTileCullingCS.h"
#include "ParticleDepthBoundsCS.h"

#include "ParticleSortIndirectArgsCS.h"
#include "ParticlePreSortCS.h"
...
{
	bool Enable = false;
    bool EnableSpriteSort = true;
    bool EnableTiledRendering = true;
	bool PauseSim = false;
    const char* ResolutionLabels[] = { "High-Res", "Low-Res", "Dynamic" };
	int TiledRes = 2;
    float DynamicResLevel = 0.0f;
	float MipBias = 0.0f;
