...
namespace Graphics
{
	...
	extern ColorBuffer g_ScenePositionBuffer;
	extern ColorBuffer g_SceneAlbedoBuffer;
	extern ColorBuffer g_SceneSpecularBuffer;
	extern ColorBuffer g_SceneEmissionBuffer;
	...
	extern ColorBuffer g_GradLinearDepth;
