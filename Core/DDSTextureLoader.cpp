...
#define align_to(_alignment, _val) ((((_val) + (_alignment) - 1) / (_alignment)) * (_alignment))
	...
	// BC formats align to 4
	if (intFormat >= 70 && intFormat <= 84 || intFormat >= 94 && intFormat <= 99)
	{
		ResourceDesc.Width = align_to(4, ResourceDesc.Width);
		ResourceDesc.Height = align_to(4, ResourceDesc.Height);
	}
