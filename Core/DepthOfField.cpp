...
#include "DoFPass1CS.h"
#include "DoFTilePassCS.h"
#include "DoFTilePassFixupCS.h"
#include "DoFPreFilterCS.h"
#include "DoFPreFilterFastCS.h"
#include "DoFPreFilterFixupCS.h"
#include "DoFPass2CS.h"
#include "DoFPass2FastCS.h"
#include "DoFPass2FixupCS.h"
#include "DoFPass2DebugCS.h"
#include "DoFMedianFilterCS.h"
#include "DoFMedianFilterSepAlphaCS.h"
#include "DoFMedianFilterFixupCS.h"
#include "DoFCombineCS.h"
#include "DoFCombine2CS.h"
#include "DoFCombineFastCS.h"
#include "DoFCombineFast2CS.h"
#include "DoFDebugRedCS.h"
#include "DoFDebugGreenCS.h"
#include "DoFDebugBlueCS.h"

using namespace Graphics;

namespace DepthOfField
{
    BoolVar Enable("Post Effects/Depth of Field/Enable", false);
    BoolVar EnablePreFilter("Post Effects/Depth of Field/PreFilter", true);
    BoolVar MedianFilter("Post Effects/Depth of Field/Median Filter", true);
    BoolVar MedianAlpha("Post Effects/Depth of Field/Median Alpha", false);
    NumVar FocalDepth("Post Effects/Depth of Field/Focal Center", 0.1f, 0.0f, 1.0f, 0.01f);
    NumVar FocalRange("Post Effects/Depth of Field/Focal Radius", 0.1f, 0.0f, 1.0f, 0.01f);
    NumVar ForegroundRange("Post Effects/Depth of Field/FG Range", 100.0f, 10.0f, 1000.0f, 10.0f);
    NumVar AntiSparkleWeight("Post Effects/Depth of Field/AntiSparkle", 1.0f, 0.0f, 10.0f, 1.0f);
    const char* DebugLabels[] = { "Off", "Foreground", "Background", "FG Alpha", "CoC" };
    EnumVar DebugMode("Post Effects/Depth of Field/Debug Mode", 0, _countof(DebugLabels), DebugLabels);
    BoolVar DebugTiles("Post Effects/Depth of Field/Debug Tiles", false);
    BoolVar ForceSlow("Post Effects/Depth of Field/Force Slow Path", false);
    BoolVar ForceFast("Post Effects/Depth of Field/Force Fast Path", false);
